...
const props = defineProps<{
  citizenship: CitizenshipPreviewDTO;
}>();
</script>
...
<template>
  <NuxtLink
    ...
    class="flex flex-col gap-3 rounded-md border border-default p-3 text-highlighted transition-colors hover:border-accented hover:text-primary focus-visible:border-accented focus-visible:outline-none"
  >
