         ...
         <div v-if="details.district" class="flex flex-col gap-2 py-1.5" :class="compact ? 'grid grid-cols-[minmax(0,9.5rem)_minmax(0,1fr)] items-start gap-3 py-2.5' : ''">
          ...
          <div>
            <NuxtLink
              ...
              class="inline-flex rounded-md border border-default px-2 py-1 text-sm font-semibold text-highlighted transition-colors duration-150 hover:border-accented hover:text-primary hover:shadow-md focus-visible:border-accented focus-visible:text-primary focus-visible:shadow-md focus-visible:outline-none"
