  ...
  <div class="flex flex-col gap-16 pb-10 sm:gap-20 lg:gap-24">
    ...
    >
      ...
      >
        <div class="flex flex-1 flex-col justify-center">
          ...
          <h1
            id="hero-title"
            class="max-w-6xl font-sans text-6xl font-semibold text-balance text-stone-100 sm:text-7xl lg:text-8xl xl:text-9xl"
          >
        ...
        >
          ...
          <img
            ...
            class="h-full min-h-32 w-full object-cover object-center sm:min-h-44 lg:min-h-44"
          />
        </NuxtLink>
    ...
    >
      <div class="mb-9 sm:mb-12">
        <h2
          class="font-sans text-3xl font-semibold tracking-tight text-highlighted sm:text-4xl lg:text-5xl"
        >
          Recherche
        </h2>
      </div>
