  ...
  <div class="flex flex-col gap-3 md:grid md:grid-cols-3">
      ...
      <Card class="hover:shadow-md">
        <template #header>
          <div class="flex justify-center pt-5">
            <i class="pi pi-home text-5xl md:text-7xl"/>
          </div>
        </template>
        <template #title>
          <h3 class="text-center text-xl text-black montserrat-headline font-bold">Häuser</h3>
        </template>
      </Card>
    </NuxtLink>
    <NuxtLink to="/places" prefetch>
      <Card class="hover:shadow-md">
        <template #header>
          <div class="flex justify-center pt-5">
            <i class="pi pi-map-marker text-5xl md:text-7xl"/>
          </div>
        </template>
        <template #title>
    ...
    <NuxtLink to="/persons" prefetch>
      <Card class="hover:shadow-md">
        <template #header>
          <div class="flex justify-center pt-5">
            <i class="pi pi-user text-5xl md:text-7xl"/>
          </div>
        </template>
        <template #title>
    ...
    <Card class="hover:shadow-md">
      <template #header>
        <div class="flex justify-center pt-5">
          <i class="pi pi-id-card text-5xl md:text-7xl"/>
        </div>
      </template>
      <template #title>
    ...
    <Card class="hover:shadow-md">
      <template #header>
        <div class="flex justify-center pt-5">
          <i class="pi pi-book text-5xl md:text-7xl"/>
        </div>
      </template>
      <template #title>
    ...
    <Card class="hover:shadow-md">
      <template #header>
        <div class="flex justify-center pt-5">
          <i class="pi pi-building-columns text-5xl md:text-7xl"/>
        </div>
      </template>
      <template #title>
        <h3 class="text-center text-xl text-black montserrat-headline font-bold">Steuer</h3>
      </template>
    </Card>
  </div>
</template>
