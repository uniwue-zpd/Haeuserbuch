...
<template>
  <div class="flex flex-col gap-2 w-[80%] mx-auto">
    ...
    >
      <div
        class="flex flex-col gap-3 p-4 bg-gray-100 border border-gray-200 rounded-md shadow-md"
      >
        <div class="text-center font-bold text-2xl">Allgemeine Angaben</div>
        ...
        <FormKit
          ...
          outer-class="max-w-full"
        />
        <div class="text-center font-bold text-2xl">Herkunft</div>
        <FormKit type="group" name="origin">
          <div
            class="flex flex-col gap-2 p-4 bg-gray-200 border border-gray-300 rounded-md shadow-sm"
          >
            <FormKit
              type="text"
              name="originalText"
        ...
        <div class="text-center font-bold text-2xl">Bezug zum Gebäude</div>
        <FormKit
          type="entityAutocomplete"
          entityType="building"
          ...
          outer-class="max-w-full"
        />
        <div class="text-center font-bold text-2xl">Berufliche Situation</div>
        ...
        <div class="text-center font-bold text-2xl">Bewaffnung</div>
        <FormKit
          type="list"
          :value="[]"
          name="weapons"
        ...
        >
          ...
          <button
            type="button"
            @click="
              () => node.input(value?.concat({ weapon: {}, originalText: '' }))
            "
        ...
        <div class="text-center font-bold text-2xl">Notizen</div>
        <FormKit
          type="textarea"
          name="internalNotes"
      ...
      <Fieldset class="mb-4 mt-4">
        ...
        <div
          class="max-h-[500px] overflow-y-auto bg-gray-100 border border-gray-200 rounded-md"
        >
