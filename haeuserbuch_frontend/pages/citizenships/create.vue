...
<template>
  <div class="flex flex-col gap-4">
    <div class="flex flex-col gap-2">
      <h1 class="montserrat-headline font-bold text-3xl">Neue Bürgermatrikel erstellen</h1>
      <p class="font-bold">Hinweise:</p>
      <ul class="list-disc list-inside">
        <li>Erstellen Sie zuerst den Herkunftsort der Person, falls noch keiner in der Datenbank existiert</li>
        <li>Erstellen Sie danach die Person selbst, falls diese noch nicht erfasst wurde.</li>
        <li>Abschließend können Sie die Bürgermatrikel der Person hinzufügen.</li>
      </ul>
    </div>
    <Stepper value="1">
      <StepItem value="1">
      ...
      <StepItem value="3">
        ...
        <StepPanel v-slot="{ activateCallback }">
          <div class="flex flex-col gap-2">
            <CitizenshipForm header="Neue Bürgermatrikel hinzufügen" action="create"/>
            <div class="flex flex-row space-x-5 justify-center">
              <button
                  @click="activateCallback('2')"
                  class="flex flex-row space-x-1 text-lg items-center bg-gray-300 hover:bg-gray-400 font-semibold p-2 rounded-md shadow-md"
              >
                <Icon name="material-symbols:arrow-back" class="inline-block mr-1"/>
                <span>Zurück</span>
              </button>
            </div>
          </div>
